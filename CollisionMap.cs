...
namespace Atode
{
    ...
    public struct MapObject
    {
        ...
        public MapObject(MapChip chipnumber, int localnumber, int objectnumber, Snake snk) : this()
        {
    ...
    public class CollisionMap
    {
        ...
        public CollisionMap(int maxobject)
        {
            ...
            SetObject(0, MapChip.None, 0,null);
        }
        public void SetObject(int mapobjectno,MapChip chiptype,int localnumber,Snake snk)
        {
            obj[mapobjectno] = new MapObject(chiptype, localnumber, mapobjectno,snk);
        }
